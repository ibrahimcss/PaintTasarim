 ...
 * @author Öğrenci
 */
public class Roket extends Sekil {
    ...
    private final static double[] X = {0,
        Math.cos(BETA) / FACTOR,
        Math.cos(ALFA),
        // Math.cos(ALFA) / FACTOR,
        // Math.cos(BETA),
        0,
        -Math.cos(BETA),
        -Math.cos(ALFA) / FACTOR,
        ...
        // -Math.cos(BETA) / FACTOR,
        0};
    private final static double[] Y = {-1, -Math.sin(BETA) / FACTOR,
        -Math.sin(ALFA),
        //Math.sin(ALFA) / FACTOR, Math.sin(BETA),
        1 / FACTOR,
        Math.sin(BETA),
        Math.sin(ALFA) / FACTOR,
        // -Math.sin(ALFA),
        // -Math.sin(BETA) / FACTOR,
        -1};
    ...
    public Roket(Point start, Point end,Ozellik ozellik) {
